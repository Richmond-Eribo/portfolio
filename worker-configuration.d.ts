/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cad93f1e72ea14a0efdb8752962a7728)
// Runtime types generated with workerd@1.20250525.0 2024-11-11 nodejs_als
declare namespace Cloudflare {
	interface Env {
		VITE_PUBLIC_R2_STORAGE_URL: {"type":"string"};
		ASSETS: Fetcher;
	}
}
